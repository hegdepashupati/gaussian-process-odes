...
from src.gpode_shooting.model_builder import build_model
from src.gpode_shooting.model_builder import compute_predictions, compute_summary, compute_loss
from src.gpode_shooting.model_initialization import initialize_inducing, initialize_latents_with_data
from src.gpode_shooting.plots_2d import plot_model_initialization, plot_trace
from src.gpode_shooting.plots_2d import plot_inducing_posterior, plot_longitudinal, plot_vectorfield
...
parser = argparse.ArgumentParser('Learning Van der Pol system (varying sequence length) with GPODE-shooting')
...
parser.add_argument('--save', type=str, default='results/vdp/gpode-shooting',
...
if __name__ == '__main__':
    ...
    for itr in range(1, args.num_iter):
        try:
            ...
            loss, observ_nll, state_kl, init_kl, inducing_kl = compute_loss(model, train_ys, train_ts,
